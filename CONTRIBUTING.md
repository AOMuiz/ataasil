...
# Contributing to Ataasil University
...
Before you ask a question, it is best to search for existing [Issues](https://github.com/AOMuiz/ataasil/issues) that might help you. In case you have found a suitable issue and still need clarification, you can write your question in this issue. It is also advisable to search the internet for answers first.

If you then still feel the need to ask a question and need clarification, we recommend the following:

- Open an [Issue](https://github.com/AOMuiz/ataasil/issues/new).
...
- To see if other users have experienced (and potentially already solved) the same issue you are having, check if there is not already a bug report existing for your bug or error in the [bug tracker](https://github.com/AOMuiz/ataasilissues?q=label%3Abug).
...
- Open an [Issue](https://github.com/AOMuiz/ataasil/issues/new). (Since we can't be sure at this point whether it is a bug or not, we ask you not to talk about a bug yet and not to label the issue.)
...
This section guides you through submitting an enhancement suggestion for Ataasil University, **including completely new features and minor improvements to existing functionality**. Following these guidelines will help maintainers and the community to understand your suggestion and find related suggestions.
...
- Perform a [search](https://github.com/AOMuiz/ataasil/issues) to see if the enhancement has already been suggested. If it has, add a comment to the existing issue instead of opening a new one.
...
Enhancement suggestions are tracked as [GitHub issues](https://github.com/AOMuiz/ataasil/issues).
...
- **Explain why this enhancement would be useful** to most Ataasil University users. You may also want to point out the other projects that solved it better and which could serve as inspiration.
...
- Consider starting the commit message with an applicable **emoji or keyword**:
  - :art: `:art:` or refactor - when improving the format/structure of the code
  - :racehorse: `:racehorse:` - when improving performance
  - :memo: `:memo:` - when writing docs
  - :bug: `:bug:` or bug - when fixing a bug
  - :fire: `:fire:` or chore - when removing code or files
...
This guide is based on the **contributing-gen**. [Make your own](https://github.com/bttger/contributing-gen)! and **atom editor** [atom](https://github.com/atom/atom/edit/master/CONTRIBUTING.md)!
