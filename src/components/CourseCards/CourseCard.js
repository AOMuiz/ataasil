...
const CourseCard = ({ courseDetail }) => {
  ...
  return (
    <>
      <article className="group  min-w-[270px] rounded-[30px] bg-white shadow-md transition-all hover:-translate-y-2">
        <Link href="/course">
        ...
        <div className="p-6">
          ...
          <p className=" py-3 text-lg font-bold">{t("coursecards.title")}</p>
