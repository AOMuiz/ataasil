...
//             <div tw="border-black border h-8 w-8 bg-primary-P700"></div>
//           </div>
//         </div>
...
//             <div>{t("sign up page.email notification")}</div>
//           </div>
//           <div tw="flex gap-2">
//             <div tw="border-black border h-6 w-6"></div>
//             <div>{t("sign up page.text notification")}</div>
//           </div>
//           <div tw="flex gap-2 py-2">
//             <div tw="border-black border h-6 w-6"></div>
//             <div>{t("sign up page.agreement")}</div>
//           </div>
//         </div>

//         <div>
//           <div tw="p-12 rounded-xl bg-[#D5D5D5]">
